...
export default function PrintMore({ MoreArticles, num }) {
  ...
  const total_HT = MoreArticles.length != 0 ? ((MoreArticles.map((e: { prix_unitaire: number, quantite: number }) => (e.quantite * e.prix_unitaire))).reduce((acc, el) => acc + el) | 0) : 0
    ...
    <div className="view-invoices fixed times  left-0 top-0 z-50   w-full h-[870px] flex justify-center">
      ...
      <div className="cadre relative w-[560px] h-full bg-white pt-4">
        <div className="head">
          ...
          {
            (((MoreArticles[0]?.dataClient.nif)?.trim() != "") && (MoreArticles[0]?.dataClient.stat)?.trim() != "") &&
        ...
        <div className="client flex justify-between px-6 pt-2">
          <div className="idt flex flex-col">
            <div className="list flex MoreArticles[0]s-center gap-4">
              ...
              <input type="text" defaultValue={`${MoreArticles[0]?.dataClient.firstName} ${MoreArticles[0]?.dataClient.name}`} className="outline-none text-sm" style={{ fontSize: "10px" }} />
            </div>
            <div className="list flex MoreArticles[0]s-center gap-4">
              <h3 className="text-sm font-bold text-black  w-12 flex justify-between" style={{ fontSize: "9px" }}>Adresse   <span>:</span></h3>
              <input type="text" defaultValue={MoreArticles[0]?.dataClient.adresse} className="outline-none text-sm w-64" style={{ fontSize: "10px" }} />
            </div>
            <div className="list flex MoreArticles[0]s-center gap-4">
              <h3 className="text-sm font-bold text-black  w-12 flex justify-between" style={{ fontSize: "9px" }}>Téléphone   <span>:</span></h3>
              <input type="text" defaultValue={MoreArticles[0]?.dataClient.telephone} className="outline-none text-sm" style={{ fontSize: "10px" }} />
            </div>
            <div className="list flex MoreArticles[0]s-center gap-4">
              <h3 className="text-sm font-bold text-black  w-12 flex justify-between" style={{ fontSize: "9px" }}>NIF   <span>:</span></h3>
              <input type="text" defaultValue={MoreArticles[0]?.dataClient.nif} className="outline-none text-sm" style={{ fontSize: "10px" }} />
            </div>
            <div className="list flex MoreArticles[0]s-center gap-4">
              ...
              <div className="" style={{ width: "130px", borderBottom: "1px double black", paddingBottom: "2px" }}>
                <div className=" " style={{ borderBottom: "1px double black" }}>
                  <h4 className="text-black text-end font-semibold" style={{ fontSize: "12px" }}>
                    ...
                    {formatNumber(total_HT + (total_HT * 0.2))}  Ar</h4>
                </div>
              </div>
            </div>
            }
        ...
        <div className="mt-2">
          ...
          <p className="text-center uppercase font-semibold" style={{ fontSize: "12px" }}>{toWords.convert(MoreArticles[0].TVA != 0 ? (total_HT + (total_HT * 0.2)) :(total_HT ))  } </p>
        </div>
        <div className="foot px-6 mt-4 ">
          ...
          <div className="flex justify-between w-full">
            <div className="mode w-[340px]">
              ...
              <h2 className="  mt-1 capitalize ml-20" style={{ fontSize: "13px", fontWeight:"bold"  }}>Client</h2>
